...
func Group(n int) group {
	switch n {
	default: return Group4096()
	case 1024: return Group1024()
	case 1536: return Group1536()
	case 2048: return Group2048()
	case 4096: return Group4096()
	}
}
...
func Group1024() group {
	return group{
		g: []byte{0x02},
		N: []byte{0xEE, 0xAF, 0x0A, 0xB9, 0xAD, 0xB3, 0x8D, 0xD6, 0x9C, 0x33, 0xF8, 0x0A,
...
//todo check and
func Group1536() group {
	return group{
		g: []byte{0x02},
		N: []byte{},
	}
}
